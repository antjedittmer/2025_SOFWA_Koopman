...
loadMat = 0; % Switch: Load existing matfile if available instead of running
             % prediction again
...
%% Load the data
if exist(aMatFullfilename,'file') == 2 && loadMat == 1 && isequal(koopmanVec,3) && isequal(noStates,[4,6,12,24])
    ...
    save(aMatFullfilename,'plotStruct','plotStruct','scalingfactors','meanvalues');
end
